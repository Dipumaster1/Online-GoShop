  ...
  useEffect(() => {
    const getdata = async () => {
      ...
      if (userinfo && userinfo.Authorization)
        return await getallexecutives(userinfo.Authorization);
      localStorage.clear();
      return navigate("/");
    };
    getdata();
          ...
          <div className="container-fluid">
            ...
            <div className="row pb-4 gy-3">
              <div className="col-sm-4">
                ...
                >
                  <i className="las la-plus me-1" /> Add Executive
                </button>
              </div>
                ...
                <div className="row align-items-center mb-2 gy-3">
                  <div className="col-md-5">
                    <p className="mb-0 text-muted">
                      ...
                      <b>{Math.min(currentpage * usersperpage, data.length)}</b>{" "}
