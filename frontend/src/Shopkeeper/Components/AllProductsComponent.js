  ...
  useEffect(() => {
    const getdata = async () => {
      ...
      if (userinfo && userinfo.Authorization)
        return await getallproducts(userinfo.Authorization);
      localStorage.clear();
      return navigate("/");
    };
    getdata();
    ...
    <div>
          ...
          <div className="container-fluid">
            ...
            <div className="row pb-4 gy-3">
              <div className="col-sm-4">
                ...
                >
                  <i className="las la-plus me-1" /> Add Products
                </button>
              </div>
                    ...
                    <div className="row align-items-center mb-2 gy-3">
                      <div className="col-md-5">
                        <p className="mb-0 text-muted">
                          Showing{" "}
                          <b>{(currentpage - 1) * productsperpage + 1}</b> to{" "}
                          <b>
                            {Math.min(
      ...
      {EditProductToggle && (
        <EditProductModal
          ...
          setid={seteditproductid}
          loading={editloading}
          obj={editobj}
          id={editproductid}
          setToggle={setEditProductToggle}
        />
      )}
    </div>
  );
